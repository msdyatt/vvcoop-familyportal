...
type Tab = "invitations" | "families" | "classes" | "documents" | "news" | "activity" | "integrations";
...
const CARDS: { eyebrow: string; number: string; title: string; description: string; button: string; tab: Tab }[] = [
  ...
  { eyebrow: "Configuration", number: "07", title: "Connect your tools", description: "Track connection status for Google Workspace, OpenSign, the shared calendar, and dues collection.", button: "Manage integrations", tab: "integrations" },
];
