...
**Teacher's Lounge**: one class selection at the top drives the whole page — there are no per-section class dropdowns. Sections: My classes (roster; clicking a student reveals their notes and the add-note form, hidden until then), Homework & dates, Handouts, Print queue, and Village news (read-only; admins publish, teachers read).
